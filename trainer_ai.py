...
if not OPENAI_API_KEY: 
    ...
    raise ValueError("ERROR: API Key is not set in environment 
variables.")
...
def debug_api_key(): 
    ...
    return {"API_KEY_STATUS": key_status, "API_KEY": OPENAI_API_KEY[:5] + 
"**********" if OPENAI_API_KEY else "MISSING"}
...
def horse_trainer_agent(question: str):
    ...
    try:
        ...
        logging.info(f"✅ Response: {answer[:50]}...")
